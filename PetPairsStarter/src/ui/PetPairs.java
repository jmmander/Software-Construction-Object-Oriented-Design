...
public class PetPairs {
    ...
    public PetPairs() {
        Cat cat = new Cat("calico", false, true, 55.00, null);
        Dog dog = new Dog("black");
        Parrot parrot = new Parrot("green and red", true, false, 20.00, null);
        Bunny bunny = new Bunny("white", false, false, 10.00, null);
