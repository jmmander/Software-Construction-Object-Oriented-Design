...
public class Query implements Observer {
    ...
    public void update(Observable observable, Object o) {
        ...
        if (filter.matches(s)) {
            ...
            BufferedImage image = util.Util.imageFromURL(url);
            if (image != null) {
               map.addMapMarker(new MapMarkerImage(getLayer(), coord, getColor(), s, image));
            } else {
                map.addMapMarker(new MapMarkerColor(getLayer(),coord,getColor(), s));
